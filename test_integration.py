...
from utils import get_profile_scoped_dir, secure_write_json, secure_read_json, secure_remove, generate_request_id
import json
import os
...
def test_all_security_features():
    ...
    test_data = {
        ...
        "node": "test-node",
        "command": "ver",
        "password": "secret123"  # This should only travel in memory briefly
    }
    ...
    print("- Additional: Passwords only travel in memory briefly, never persisted")
